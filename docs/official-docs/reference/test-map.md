...
| Shopify/D1 Candidate Contract | `npm run verify:phase2` | Verifies webhook enrollment, D1 projection, Shopify CAS mutation, Redis isolation, S&S batch commit, Designer Studio private-R2 import/backfill, private asset tickets, and migration gates |
