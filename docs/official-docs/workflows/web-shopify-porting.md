...
- Active `completed` orders stay in Ready to Print with a **Production complete** badge. Shopify fulfillment does not close them; the Admin block's manual customer-handoff action archives them, and its Reopen action returns them to the board.
